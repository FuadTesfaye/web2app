...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0C0D10] text-white border-t-3 border-ink py-16 px-4 sm:px-8 font-mono text-xs">
      <div className="max-w-7xl mx-auto flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start justify-between">
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-accent-yellow text-ink border-2 border-white flex items-center justify-center font-display font-black text-xl">
                ⚡
              </div>
              <div>
                <span className="font-display font-black text-xl text-white block uppercase tracking-tight">
                  web2app
                </span>
          ...
          <div className="md:col-span-4 flex flex-col gap-3">
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <input
                ...
                className="bg-[#1A1C21] border-2 border-gray-700 px-3 py-2 text-xs font-mono text-white focus:outline-none focus:border-accent-yellow w-full"
              />
              <button
                type="submit"
                className="btn-sharp bg-accent-yellow text-ink px-4 py-2 font-black border-2 border-white shadow-neo-xs hover:bg-accent-yellow/90 uppercase tracking-wider shrink-0 flex items-center justify-center"
              >
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-gray-500 text-[11px]">
          <div>
            ...
            <span className="ml-2 text-gray-500">Architectural Brutalism System.</span>
          </div>
